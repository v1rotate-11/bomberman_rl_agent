...
def end_of_round(self, last_game_state: dict, last_action: str, events: List[str]):
    ...
    # Log the episode
    if last_game_state['round'] % 1 == 0:  # Update every 10 episodes
    ...
    if last_game_state['round'] == N_TRAINING_EPSD:
        self.tracker.save_current_session("test_run")

    """ if last_game_state['round'] == TRANSITION_HISTORY_SIZE:
